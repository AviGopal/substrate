 ...
 */
function checkImpulseLearningLineCount() {
 ...
 */
function checkNoNormalizePatternInOpencode() {
  const filePath = path.join(
    __dirname,
    '../../repos/metabob-opencode/packages/opencode/src/session/impulse-learning.ts'
  );
 ...
 */
function checkNoCalculateQualityInOpencode() {
  const filePath = path.join(
    __dirname,
    '../../repos/metabob-opencode/packages/opencode/src/session/impulse-learning.ts'
  );
 ...
 */
function checkNoTrackUsageInOpencode() {
  const filePath = path.join(
    __dirname,
    '../../repos/metabob-opencode/packages/opencode/src/session/impulse-learning.ts'
  );
 ...
 */
function checkRpcApiHasRecordTurnEndpoint() {
  const filePath = path.join(
    __dirname,
 ...
 */
function checkRpcApiHasNormalizePattern() {
  const filePath = path.join(
    __dirname,
 ...
 */
function checkRpcApiHasCalculateQuality() {
  const filePath = path.join(
    __dirname,
    '../../repos/metabob-rpc-api/server/db/operations/impulse_learning.py'
  );
 ...
 */
function checkRpcApiHasTrackUsage() {
  const filePath = path.join(
    __dirname,
    '../../repos/metabob-rpc-api/server/db/operations/impulse_learning.py'
  );
