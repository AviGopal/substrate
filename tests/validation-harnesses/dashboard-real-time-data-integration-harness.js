...
async function testServerRunning() {
  ...
  try {
    ...
    return {
      ...
      expected,
      error: `Failed to check port: ${err.message}`,
    };
  }
}
...
async function testHealthEndpoint() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Health endpoint unreachable: ${err.message}`,
    };
  }
}
...
async function testProblemsEndpoint() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Problems endpoint failed: ${err.message}`,
    };
  }
}
...
async function testActivitiesEndpoint() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Activities endpoint failed: ${err.message}`,
    };
  }
}
...
async function testSessionsEndpoint() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Sessions endpoint failed: ${err.message}`,
    };
  }
}
...
async function testDataFreshness() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Data freshness check failed: ${err.message}`,
    };
  }
}
...
async function testBackendConnectivity() {
  ...
  try {
    ...
    return {
      ...
      actual: { error: err.message },
      expected,
      error: `Backend connectivity check failed: ${err.message}`,
    };
  }
}
