...
**Test Case**: minimal  
**Date**: Mon Feb 16 04:02:09 PM PST 2026  
...
```
Error response from daemon: No such container: devbob-clean
```
...
- Full output: `./validation-results/agent-behavior/20260216_160209/acp-output.log`
- Container logs: `./validation-results/agent-behavior/20260216_160209/container-logs.txt`
- Core logs: `./validation-results/agent-behavior/20260216_160209/core-logs.txt`
