# restart-budgets Specification

## Purpose
Restart drains and deferrals are sized to the stage they protect and decided by the age of in-flight work, not by a count of busy observations.
