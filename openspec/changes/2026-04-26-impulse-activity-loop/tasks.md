...
- [ ] 18.0.4 Run validation harness once (Task 18.2 must be code-complete) and store as `validation/baselines/2026-05-09-mrr.json`. Gated on 18.2.x harness implementation.
