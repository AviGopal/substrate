...
[`architecture/IDIOM_ANALYSIS.md`](architecture/IDIOM_ANALYSIS.md) §2.1); the
...
- [`architecture/IDIOM_ANALYSIS.md`](architecture/IDIOM_ANALYSIS.md) — terminology audit; foundation-aligned terms cross-referenced.
