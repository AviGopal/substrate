...
const KEYWORD_TO_TAGS: Record<string, string[]> = {
  // Simple shell/system commands - the foundation for learning
  // These are the most common operations that should match generic templates first,
  // then specialize into more specific variants as patterns emerge
  'show': ['tool.shell', 'tool.query', 'tool'],
  'display': ['tool.shell', 'tool.query', 'tool'],
  'print': ['tool.shell', 'tool.query', 'tool'],
  'echo': ['tool.shell', 'tool.query', 'tool'],
  'list': ['tool.shell', 'tool.query', 'tool.filesystem', 'tool'],
  'ls': ['tool.shell', 'tool.filesystem', 'tool'],
  'find': ['tool.shell', 'tool.query', 'tool.filesystem', 'tool'],
  'search': ['tool.shell', 'tool.query', 'tool'],
  'grep': ['tool.shell', 'tool.query', 'tool'],
  'cat': ['tool.shell', 'tool.filesystem', 'tool'],
  'read': ['tool.shell', 'tool.filesystem', 'tool'],
  'write': ['tool.shell', 'tool.filesystem', 'tool'],
  'run': ['tool.shell', 'tool.execute', 'tool'],
  'execute': ['tool.shell', 'tool.execute', 'tool'],
  'check': ['tool.shell', 'tool.query', 'tool'],
  'get': ['tool.shell', 'tool.query', 'tool'],
  'count': ['tool.shell', 'tool.query', 'tool'],
  'version': ['tool.shell', 'tool.system', 'tool'],
  'status': ['tool.shell', 'tool.system', 'tool'],
  'info': ['tool.shell', 'tool.system', 'tool'],
  'help': ['tool.shell', 'tool.system', 'tool'],
  'current': ['tool.shell', 'tool.query', 'tool'],
  'pwd': ['tool.shell', 'tool.filesystem', 'tool'],
  'directory': ['tool.shell', 'tool.filesystem', 'tool'],
  'file': ['tool.shell', 'tool.filesystem', 'tool'],
  'files': ['tool.shell', 'tool.filesystem', 'tool'],
  'folder': ['tool.shell', 'tool.filesystem', 'tool'],
  'path': ['tool.shell', 'tool.filesystem', 'tool'],
  'tree': ['tool.shell', 'tool.filesystem', 'tool'],
  'size': ['tool.shell', 'tool.query', 'tool'],
  'disk': ['tool.shell', 'tool.system', 'tool'],
  'memory': ['tool.shell', 'tool.system', 'meta.debug'],
  'process': ['tool.shell', 'tool.system', 'tool'],
  'env': ['tool.shell', 'tool.system', 'tool'],
  'environment': ['tool.shell', 'tool.system', 'tool'],
  'variable': ['tool.shell', 'tool.system', 'tool'],
  'user': ['tool.shell', 'tool.system', 'tool'],
  'whoami': ['tool.shell', 'tool.system', 'tool'],
  'date': ['tool.shell', 'tool.system', 'tool'],
  'time': ['tool.shell', 'tool.system', 'tool'],
  'calculate': ['tool.shell', 'tool.query', 'tool'],
  'compute': ['tool.shell', 'tool.query', 'tool'],
  'what is': ['tool.shell', 'tool.query', 'tool'],
