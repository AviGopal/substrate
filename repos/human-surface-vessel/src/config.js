...
export const VESSEL_ID = process.env.HUMAN_SURFACE_VESSEL_ID ?? process.env.VESSEL_ID ?? "human-surface-vessel";
 ...
 */
export const DISCOVERY_ENDPOINT = process.env.DISCOVERY_ENDPOINT ??
 ...
 */
export const GOAL_HOST_ENDPOINT = process.env.GOAL_HOST_ENDPOINT ?? "http://127.0.0.1:8210";
export const METABOB_API_KEY = process.env.HUMAN_SURFACE_VESSEL_API_KEY ?? process.env.METABOB_API_KEY ?? "";
/**
