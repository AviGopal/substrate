-- Migration: 001
-- Description: Initial activity tracking schema (from manual initialization)
-- Author: Activity Mode
-- Date: 2026-02-28
-- Depends: 000_schema_version.sql
-- Source: Migrated from root /initialize-surrealdb-schema.sql
...
DEFINE TABLE IF NOT EXISTS template_metrics SCHEMAFULL;
...
DEFINE TABLE IF NOT EXISTS failure_patterns SCHEMAFULL;
...
DEFINE TABLE IF NOT EXISTS task_execution SCHEMAFULL;
...
DEFINE TABLE IF NOT EXISTS activity_content SCHEMAFULL;
...
CREATE schema_version CONTENT {
  ...
  migration_file: '001_initial_activity_schema.sql',
  duration_ms: 0,
  success: true
};
