...
Human-in-the-loop development interface for activities, executions, and learning-loop state. React + Vite, Vitest + Playwright, shadcn/ui primitives. **Alpha (v0.1.0) landed 2026-04-22; composition-builder + trace-viz surfaces landed 2026-04-23; ConfigEditor, history panel, and trajectory/vessel-selector refinements landed 2026-04-26.**
